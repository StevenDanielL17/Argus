...
Modify the PRIVATE_KEY in the desired example file (e.g., rest/create_market_order.py)
Run the example using Python's module execution mode:
python3 -m rest.create_market_order
Websocket Examples
The folder ws contains examples of using the Websocket API. To run an example:

Modify the PRIVATE_KEY in the desired example file (e.g., ws/create_market_order.py)
Run the example using Python's module execution mode:
python3 -m ws.create_market_order

Github LInk: https://github.com/pacifica-fi/python-sdk